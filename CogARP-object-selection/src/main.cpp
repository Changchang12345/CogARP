...
int main(int argc, char *argv[])
{
    ...
    cout << "* 2. 在线滑动窗口选择对象集        *" << endl;//online grredy
    cout << "* 3. 在线zoom in选择对象集         *" << endl;
    cout << "* 4. 在线zoom out选择对象集        *" << endl;
    cout << "* 5. 预选择对象集                  *" << endl;//precom greedy 
    cout << "* 6. 通过预选择获取窗口内对象集(一次选择) *" << endl;
    cout << "* 7. 构建索引树                    *" << endl;//前提5
    cout << "* 8. 通过索引树获得窗口对象集合     *" << endl;//preindex  前提7
    cout << "* 9. 通过索引树获得窗口对象集合next *" << endl;//preindex  前提7
    cout << "* 10. 通过索引树获得窗口对象集合pre *" << endl;//preindex  前提7
    cout << "* 11. 通过预选择获取窗口内对象集(sliding选择) *" << endl;
    cout << "* 12. 通过预选择+索引树获取窗口内对象集(sliding选择) *" << endl;
    cout << "* 13. selectRank                   *" << endl;
    cout << "* 14. LocationRank                 *" << endl;
    cout << "****************************************" << endl;
        cout <<"请输入您的选择： " ;
        cin >> choose;
        switch (choose)
        ...
        case 7:
            ...
            for(vector<poltree> v: pol_tree.getPoltree()){
                // cout<<i<<endl;
                for(poltree b:v){ 
                    cnt++;
            ...
            cout << cnt+pol_tree.geth().size() <<endl;
            
            // cout << pol_tree.geth().size() <<endl;
            /* for(poltree b: pol_tree.geth()){
                cout<< "heand::" << b.getPolidx()<<" "<< b.getHead() << " " << b.getProject().getId() << " ===" <<endl;
        ...
        case 8:
            ...
            cin >> s;
            time_start = GetTickCount(); //从操作系统启动经过的毫秒数
            lb = selectList(pol_tree,k,ws,we,s); 
            time_end = GetTickCount();
        ...
        case 9:
            ...
            cin >> s;
            time_start = GetTickCount(); //从操作系统启动经过的毫秒数
            lb = selectList_next(pol_tree,k,ws,we,s); 
            time_end = GetTickCount();
            cout << "Time = " << (time_end - time_start) << "ms\n ";
        ...
        case 10:
            ...
            cin >> s;
            time_start = GetTickCount(); //从操作系统启动经过的毫秒数
            lb = selectList_pre(pol_tree,k,ws,we,s); 
            time_end = GetTickCount();
            cout << "Time = " << (time_end - time_start) << "ms\n ";
        ...
        case 12:
            ...
            cin >> s;
            time_start = GetTickCount(); //从操作系统启动经过的毫秒数
            lb = precomIndex_sliding(pol_tree,k,s,w);
            time_end = GetTickCount();
            cout << "Time = " << (time_end - time_start) << "ms\n ";
            pl = calpol(lb);
            cout<< "认知收益" <<pl<<endl;
        ...
        case 15:
            ...
            cin >> s;
            time_start = GetTickCount(); //从操作系统启动经过的毫秒数
            lb = selectList_i_2(pol_tree,k,ws,we,s); 
            time_end = GetTickCount();
            cout << "Time = " << (time_end - time_start) << "ms\n ";
            // for(building v:lb){
            //     cout << v.getId() << " " <<endl;
        ...
        case 16:
            ...
            cin >> s;
            time_start = GetTickCount(); //从操作系统启动经过的毫秒数
            lb = selectList_i_3(pol_tree,k,ws,we,s); 
            time_end = GetTickCount();
            cout << "Time = " << (time_end - time_start) << "ms\n ";
            // for(building v:lb){
            //     cout << v.getId() << " " <<endl;
        ...
        case 17:
            ...
            cin >> s;
            time_start = GetTickCount(); //从操作系统启动经过的毫秒数
            lb = selectList_next1(pol_tree,k,ws,we,s); 
            time_end = GetTickCount();
            cout << "Time = " << (time_end - time_start) << "ms\n ";
            // for(building v:lb){
            //     cout << v.getId() << " " <<endl;
        ...
        case 18:
            ...
            cin >> s;
            time_start = GetTickCount(); //从操作系统启动经过的毫秒数
            lb = selectList_next2(pol_tree,k,ws,we,s); 
            time_end = GetTickCount();
            cout << "Time = " << (time_end - time_start) << "ms\n ";
            // for(building v:lb){
            //     cout << v.getId() << " " <<endl;
